(function() {
  ...
  angular.module('daiictSenTeam13App')
    .controller('StudentCtrl', ['$scope', '$location', '$timeout', '$rootScope', function($scope, $location, $timeout, $rootScope) {
      ...
      /**
       * @ngdoc function
       * @name daiictSenTeam13App.controller:StudentCtrl#getJobsAndChatRoomDataAndApplications
       ...
       */
      function getJobsAndChatRoomDataAndApplications() {
      ...
      getJobsAndChatRoomDataAndApplications();
